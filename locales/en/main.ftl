...
## Install chooser
chooser-title = Find the right download
chooser-subtitle = Pick your operating system for the simplest route, or explore every installation method below.
...
## Feature guides
guides-title = Explore Kopuz
guides-subtitle = Get a quick path into each major integration and feature group.
...
privacy-files-desc = Album artwork and offline tracks stay in your system cache directory. Logs can be opened or exported directly from Settings.
...
## Community
community-title = Build Kopuz with us
community-subtitle = Report problems, suggest ideas, meet other listeners, translate the interface, or contribute code.
...
community-discussions-desc = Share ideas and ask longer-form questions.
community-discord-desc = Chat with users and contributors in real time.
community-contribute-title = Contribute
community-contribute-desc = Explore the Rust codebase, development setup, and translations.
