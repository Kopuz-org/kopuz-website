...
feat-local-desc = Choisis un dossier local ou connecte-toi à Jellyfin / Subsonic (Navidrome). Ou utilise les deux en même temps.
...
feat-native-desc = MPRIS sur Linux, Now Playing sur macOS, System Media Transport sur Windows. Tout est intégré à ton système.
feat-lyrics-title = Paroles synchronisées
feat-lyrics-desc = Paroles défilantes en temps réel, synchronisées ou non, et défilement auto pour suivre la musique.
...
feat-fav-desc = Ajoute des pistes aux favoris localement ou synchronise les favoris avec ton serveur. Crée des playlists, ajoute des albums entiers d'un coup.
...
feat-genre-desc = Parcours toute ta bibliothèque par genre — fonctionne aussi bien avec les fichiers locaux que la musique de ton serveur.
feat-logs-title = Journaux d'écoute
feat-logs-desc = Compteur de lectures local. Découvre ce que tu écoutes réellement le plus.
...
feat-ytdlp-desc = Télécharge l'audio directement depuis YouTube. Export en MP3, FLAC, WAV, MP4 ou meilleure qualité. SponsorBlock, découpage par chapitre et limitation de débit inclus.
...
feat-metadata-desc = Choisis la source des images d'artistes : première pochette d'album (par défaut) ou vraies photos d'artistes récupérées depuis ton serveur Jellyfin ou Subsonic, avec fallback automatique.
...
feat-soundcloud-desc = Diffuse depuis SoundCloud après une connexion unique via votre navigateur. Profitez de la recherche, de la lecture progressive en MP3 ainsi que des flux AAC/HLS réservés aux abonnés Go+, accéde à tes titres aimés comme favoris et consulte tes playlists en lecture seule.
feat-miniplayer-title = Mini-lecteur
feat-miniplayer-desc = Active un mini-lecteur compact depuis la barre inférieure pour une vue plus discrète.
feat-tray-title = Réduire dans la barre des tâches
feat-tray-desc = Se réduit dans la zone de notification système au lieu de se fermer, afin que la lecture continue en arrière-plan. Cette option peut être activée ou désactivée dans les Paramètres.
feat-badges-title = Badges de format de fichier
feat-badges-desc = Les pistes locales affichent un petit badge indiquant le format — MP3, FLAC, WAV, et plus — directement dans la ligne de la piste.

## Performance
perf-title = Conçu pour être rapide.
perf-subtitle = Grandes bibliothèques. Démarrage instantané. Aucun ralentissement.
...
perf-lazy-label = Chargement différé des images
...
perf-http-label = Cache HTTP des pochettes
...
gallery-fullscreen-desc = Vue de lecture immersive en plein écran.
gallery-fullscreen-lyrics-title = Paroles en plein écran
gallery-fullscreen-lyrics-desc = Paroles synchronisées en plein écran.
...
join-no-payload = Ce lien ne contient aucune liste de lecture.
